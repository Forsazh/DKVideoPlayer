...
public abstract class BaseVideoController extends FrameLayout
    ...
    public void addControlComponent(IControlComponent component, boolean isPrivate) {
        ...
        if (mControlWrapper != null) component.attach(mControlWrapper);
        View view = component.getView();
        if (view != null && !isPrivate) addView(view, 0);
    }
    ...
    protected void onPlayerStateChanged(int playerState) {
        switch (playerState) {
            case VideoView.PLAYER_NORMAL:
                ...
                else mOrientationHelper.disable();
                if (hasCutout()) {
