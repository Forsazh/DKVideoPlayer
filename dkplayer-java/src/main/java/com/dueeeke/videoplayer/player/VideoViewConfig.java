...
public class VideoViewConfig {
    ...
    private VideoViewConfig(Builder builder) {
        ...
        if (builder.mPlayerFactory == null) mPlayerFactory = new AndroidMediaPlayerFactory();
        else mPlayerFactory = builder.mPlayerFactory;
        if (builder.mRenderViewFactory == null) mRenderViewFactory = new TextureRenderViewFactory();
        else mRenderViewFactory = builder.mRenderViewFactory;
